...
description: End-to-end UK construction job-hunting workflow for university students at any year level — 1st year through final year and recent graduates. Targets graduate construction manager roles, summer internships, year-in-industry placements, and trainee positions across the UK. Use this skill whenever the user wants to find construction graduate jobs or placements, tailor a student CV for a specific role, write a cover letter, log applications, prepare for graduate scheme interviews, draft follow-up emails, or check whether they have already applied. Trigger on phrases like "find me a placement", "find me a graduate construction job", "tailor my CV", "write a cover letter", "log this application", or "interview prep". Always uses STAR (Situation, Task, Action, Result) for CV bullets and cover letter content, and never fabricates experience, qualifications, or dates. Runs a one-time setup on first use to capture each student's profile.
---
